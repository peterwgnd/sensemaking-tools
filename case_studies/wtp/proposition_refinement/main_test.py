...
from case_studies.wtp.proposition_refinement import main as proposition_refinement_main
...
class PropositionRefinementMainTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.pickle_dump_patcher = patch(
        "case_studies.wtp.proposition_refinement.main.pickle.dump"
    )
  ...
  @patch(
      "case_studies.wtp.proposition_refinement.main.simulated_jury.run_simulated_jury",
      new_callable=AsyncMock,
  )
  @patch(
      "case_studies.wtp.proposition_refinement.main.schulze.get_schulze_ranking"
  )
  ...
  @patch(
      "case_studies.wtp.proposition_refinement.main.deduplication.run_deduplication",
      new_callable=AsyncMock,
  )
  ...
  @patch(
      "case_studies.wtp.proposition_refinement.main.nuanced_propositions.combine_propositions",
      new_callable=AsyncMock,
  )
  ...
  def mock_pipeline_stages(self):
    ...
    with patch(
        "case_studies.wtp.proposition_refinement.main.run_r2_opinion_ranking"
    ) as mock_stage_1:
      mock_stage_1.return_value = self.sample_world_model
      with patch(
          "case_studies.wtp.proposition_refinement.main.run_initial_approval_jury",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.run_jury_by_opinion",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.run_jury_by_topic",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.run_nuanced_ranking_jury",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.rank_nuanced_propositions",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.generate_nuanced_propositions",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.run_nuanced_approval_jury",
          new_callable=AsyncMock,
      ), patch(
          "case_studies.wtp.proposition_refinement.main.genai_model.GenaiModel"
      ):
        yield mock_stage_1
  ...
  def test_jury_size_selection(self):
    ...
    with patch(
        "case_studies.wtp.proposition_refinement.main.get_jury_pool"
    ) as mock_get_pool, patch(
        "argparse.ArgumentParser.parse_args", return_value=self.mock_args
    ), patch(
        "case_studies.wtp.proposition_refinement.main.pickle.load",
